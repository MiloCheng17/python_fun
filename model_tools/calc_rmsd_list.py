...
if __name__ == '__main__':
    ...
    parser.add_argument('-pdbr', dest='pdbr', default=None, help='pdb reference file')
    parser.add_argument('-pdbl', dest='pdbl', default=None, help='pdb list file')
    parser.add_argument('-outf',  dest='outf', default=None, help='out name')
